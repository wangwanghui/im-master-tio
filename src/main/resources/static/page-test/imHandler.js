var IMHandler = function () {
  ...
  this.onmessage = function (event, ws) {
    ...
    var ico,imgcls,spancls,ncikcls;
       console.log("AAA " + "msgBody.type" +msgBody.type);
       console.log("msgBody.filePath  " +msgBody.filePath);
    ...
    if (msgBody.name=="admin")
    	...
    	}else if (msgBody.type == "T")
		{
		   ...
		   content.innerHTML += '<li><img src="'+msgBody.filePath+'"></img></li>';
		}
